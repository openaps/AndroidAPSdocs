...
<ul>
  ...
  <li>
    <a href="../Configuration/Accu-Chek-Insight-Pump.md">Pompa Accu-Chek Insight</a>
  </li>
  <li>
...
<ul>
  <li>
    The Dana pumps connect to almost any phone with Android >= 5.1 without the need to flash lineage. If your phone breaks you usually can find easily any phone that works with the Dana pumps as quick replacement... not so easy with the Combo. (Może się to zmienić w przyszłości, gdy Android 8.1 stanie się bardziej popularny)
  </li>
  <li>
    Initial pairing is simpler with the Dana-i/RS. Ale zwykle robisz to tylko raz, więc ma to wpływ tylko wtedy, gdy chcesz przetestować nową funkcję za pomocą różnych pomp.
  </li>
  <li>
  ...
  <li>
    The Combo vibrates on the end of TBRs, the DanaR vibrates (or beeps) on SMB. W nocy prawdopodobnie będziesz używać częściej TBRs niż SMB.  The Dana-i/RS is configurable that it does neither beep or vibrate.
  </li>
  <li>
