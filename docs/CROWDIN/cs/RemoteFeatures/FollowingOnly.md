...
* Dexcom Follow is compatible with a wide range of handsets (both Android and iPhone). Dexcom Follow lze použít i v případě, že nepoužíváte oficiální aplikaci Dexcom pro příjem dat senzoru.

* Many caregivers are familiar with Dexcom Follow, preferring its clear interface over something more complicated.

* Dexcom Follow is very good for teachers/grandparents and people who know very little about diabetes and sugar levels. It has customisable alerts (BG level, what sound to play etc.). Alarmy mohou být v případě potřeby zcela vypnuty, což je velmi užitečné, pokud máte senzor, který se stále usazuje a vytváří několikanásobné falešné dolů.
