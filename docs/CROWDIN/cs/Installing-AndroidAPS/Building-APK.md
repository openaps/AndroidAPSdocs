...
2. [Instalace Android Studio](../Installing-AndroidAPS/Building-APK.md#install-android-studio)
3. [Nastavte v předvolbách Android Studio cestu ke gitu](../Installing-AndroidAPS/Building-APK.md#set-git-path-in-preferences)
4. [Stáhněte si kód AndroidAPS](../Installing-AndroidAPS/Building-APK.md#download-androidaps-code)
5. [Stáhněte Android SDK](../Installing-AndroidAPS/Building-APK.md#download-android-sdk)
6. [Build the app](../Installing-AndroidAPS/Building-APK.md#generate-signed-apk) (generate signed apk)
7. [Nahrajte aplikaci do mobilu](../Installing-AndroidAPS/Building-APK.md#transfer-apk-to-smartphone)
8. [Možnost „Identify receiver“ při používání xDripu+](..//Configuration/xdrip.md#identify-receiver)
...
* Click "Build" (1) in the menu bar and select "Generate Signed Bundle / APK..." (2).
    ...
    ![Sestavení apk](../images/studioSetup/42_MenuBuild.png)
...
* Click on the link "locate".
    ...
    * If the notification is gone, you can always open the "Event log" and select the same link there. ![Úspěšné sestavení - event log](../images/studioSetup/53_EventLog.png)
