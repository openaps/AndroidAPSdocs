...
Při používání **AAPS** neberte SGLT-2 inhibitory (glifloziny), protože nepředvídatelně snižují hladinu cukru v krvi. Combining this effect with a system that lowers basal rates in order to increase BG is dangerous, there is more detail about this in the main [safety section](../preparing.md#safety-first).
...
Chcete se dozvědět, jak začít používat AAPS? Take a look at the [preparing](../preparing.md) section.
