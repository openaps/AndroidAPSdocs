...
Pokud uvidíte výše uvedené varování po použití průvodce bolusem, funkce AndroidAPS zjistila, že vypočtená hodnota COB může být chybná. Takže pokud dávate bolus znovu po předchozím jídle s COB, měli byste si dát pozor na předávkování! Podrobnosti viz pokyny na [stránce výpočtu COB](../Usage/COB-calculation.html#detection-of-wrong-cob-values).
