...
Změny provedené v editoru profilu v Nightscoutu můžete synchronizovat s lokálními profily. The settings can be found in [NSClient preferences](../Configuration/Preferences.md#nsclient).
