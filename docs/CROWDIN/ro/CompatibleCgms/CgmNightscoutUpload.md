...
```{important}
Această sursă de date nu va funcționa atunci când sunteți offline, când întâmpinați probleme de rețea sau când instanța de Nightscout este căzută. Utilizați cu prudență.
```
