...
- Install ruffy and use it to pair the pump. If it doesn't work after multiple attempts, switch to the `pairing` branch, pair the pump and then switch back the original branch. De notat faptul că procesul de împerechere este oarecum problematic (însă este suficient doar să reușească o singură dată) și poate necesita câteva încercări; răspundeți rapid la mesajele afișate și, atunci când reîncercați, mai întâi ștergeți pompa din lista de dispozitive Bluetooth asociate. O altă opțiune ar fi să încercați să accesați meniul Bluetooth al telefonului imediat după inițierea procesului de împerechere (aceasta va ține dispozitivul Bluetooth al telefonului vizibil atâta timp cât meniul este afișat) și să reveniți din nou la ruffy pentru confirmarea împerecherii cu pompa, atunci când pompa afișează codul de autorizare. Dacă totuși nu reușiti să duceți la bun sfârșit împerecherea cu pompa (să spunem după 10 încercări), așteptați până la 10 secunde înainte de a confirma împerecherea cu pompa (atunci când numele telefonului este afișat pe ecranul pompei). Dacă ați configurat ca meniul pompei să se stingă după 5 secunde, va fi necesar să măriți din nou acest interval. Câțiva utilizatori au raportat faptul că această setare a fost necesară. Ca o ultimă soluție, puteți încerca să vă mutați într-o altă încăpere pentru a evita eventualele interferențe radio locale. Cel puțin un utilizator a reușit să treacă cu succes peste etapa de împerechere cu pompa doar schimbând camera în care încerca acest lucru.
