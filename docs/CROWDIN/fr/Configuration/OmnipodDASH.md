...
* **Un téléphone Android compatible** avec une connexion Bluetooth BLE
   ...
   -  **Version 3.0 ou plus récente d'AndroidAPS construit et installé** en utilisant les instructions [**Build APK**](../Installing-AndroidAPS/Building-APK#).
...
Il est recommandé d'exporter les paramètres APRES l'activation du pod. Faites cela à chaque changement de pod et une fois par mois, copiez le fichier exporté sur votre lecteur Internet. voir le [**Doc paramètres d'exportation**](../Usage/ExportImportSettings.md?highlight=exporting#export-import-des-parametres).
