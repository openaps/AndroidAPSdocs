...
Les profils locaux peuvent également être téléchargés sur Nightscout. The settings can be found in [NSClient preferences](../Configuration/Preferences#nsclient).
