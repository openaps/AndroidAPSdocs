...
* Maintenant, nous approchons de notre premier message d'erreur. Heureusement, Android Studio nous donnera directement la solution pour cela. (In case you do not receive the error message shown in next screenshot try closing and restarting Android Studio.)
