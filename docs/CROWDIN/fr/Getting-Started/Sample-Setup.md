...
3. Démarrez xDrip+ et indiquez les paramètres suivants (menu hamburger en haut à gauche) 
    ...
    * Menu > Start sensor (is only "pro forma" and has nothing to do with the running G6 sensor. Ceci est nécessaire sinon un message d'erreur apparaîtra régulièrement.) 
