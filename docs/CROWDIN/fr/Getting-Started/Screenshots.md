...
* La zone verte reflète votre fourchette cible. It can be configured in [preferences](../Configuration/Preferences.md#range-for-visualization).
...
* barres **VERTES** montrent que la Gly est supérieure à l'attendu de l'algorithme Green bars are used to increase resistance in [Autosens](../Usage/Open-APS-features.md#autosens).
* barres **ROUGES** montrent que la Gly est inférieur à l'attendu de l'algorithme. Red bars are used to increase sensitivity in [Autosens](../Usage/Open-APS-features.md#autosens).
...
* As of version 3.0 only [local profile](../Configuration/Config-Builder.md#local-profile) is possible. Le profil local peut être modifié sur votre smartphone et synchronisé sur votre site Nightscout.
...
* [Bolus étendu](../Usage/Extended-Carbs.md#extended-bolus-and-switch-to-open-loop-dana-and-insight-pump-only)
* Basal temporaire
...
* Settings are made in [preferences](../Configuration/Preferences.md#nsclient). Vous pouvez ouvrir la section correspondante en cliquant sur la roue crantée en haut à droite de l'écran.
