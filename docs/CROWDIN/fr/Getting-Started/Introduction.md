...
Ne prenez pas d'inhibiteurs de SGLT-2 (gliflozines) lorsque vous utilisez **AAPS** car il est impossible de calculer la manière dont ils font baisser la glycémie. Combiner cet effet avec un système qui abaisse les débits de basale afin d'augmenter la glycémie est dangereux, vous trouverez plus de détails à ce sujet dans la page principale à propos de la [sûreté](../preparing.md#safety-first).
