...
| MGC                                                   | Available [BG Sources](../SettingUpAaps/ConfigBuilder.md#bg-source) |
| ----------------------------------------------------- | ------------------------------------------------------------------- |
| [Dexcom G7 et ONE+](../CompatibleCgms/DexcomG7.md)    | xDrip+, DiaKEM app or Juggluco                                      |
| [Dexcom G6 et ONE](../CompatibleCgms/DexcomG6.md)     | xDrip+ or BYODA (only G6)                                           |
