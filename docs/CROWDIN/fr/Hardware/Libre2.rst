...
The Droplet transmitter is working with Libre2 but uses a internet service. Veuillez vous référer à FB ou Google pour obtenir de plus amples informations.
