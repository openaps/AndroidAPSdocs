...
##### [Demandez à notre groupe Facebook](https://www.facebook.com/groups/AndroidAPSUsers/)

##### [Demander à notre canal discord](https://discord.com/channels/629952586895851530/629954570394533889)

### Chapitre Aperçu

AAPS documentation is made up of the following Sections:

#### [De quoi ai-je besoin ?](Module/module.md)

Ceci explique la compatibilité d'AAPS avec les MGC (Mesures de Glycémie Continue) et les pompes à insuline. Il fournit également un guide sur l'assemblage correct d'un système AAPS pour s'assurer qu'il fonctionne correctement dans la vie de tous les jours.

#### [How to build and install AAPS](Installing-AndroidAPS/Building-APK.md)

Cette section est le manuel pour la construction d'AAPS. Strict adherence to the step-by-step instructions are required in order to successfully build **AAPS**.  Veuillez prendre votre temps.
...
Cette section explique comment configurer et paramétrer votre "Profil", "Insuline", "Source de Glycémie", "Pompe", "Détection de sensibilité", "APS", "Boucle", "Traitements".
...
#### [Conseils généraux](Usage/Timezone-traveling.md)
...
#### [Résolution de problèmes](Usage/troubleshooting.md)
...
Cette section contient une liste des acronymes (ou noms raccourcis) ou des termes définis spécifiquement pour AAP (par exemple, les termes « SI » ou « CT » ont une signification spéciale dans AAPS).
