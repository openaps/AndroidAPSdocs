...
```{toctree}
:caption: "G\xE9n\xE9rateur de configuration"
:glob: true
:maxdepth: 1
...
```{toctree}
:caption: "Questions fr\xE9quentes"
:glob: true
:maxdepth: 1
...
```{toctree}
:caption: "O\xF9 chercher de l'aide"
:glob: true
:maxdepth: 1
...
```{toctree}
:caption: "Pour les professionnels de sant\xE9"
:glob: true
:maxdepth: 1
