...
Vous pouvez facilement créer un profil local à partir d'un changement de profil. In this case, timeshift and percentage will be applied to the new local profile. Use the **Clone** button shown on line **1**.
