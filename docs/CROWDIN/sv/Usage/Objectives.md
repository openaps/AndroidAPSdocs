...
- Only if you have been closed looping with another system (i.e. OpenAPS, iOS Loop) before and can proof this (i.e. at least 3 months of looping data in Nightscout), you can send an email to [objectives@androidaps.org](mailto:objectives@androidaps.org) with your NS address and request code to bypass the rest of objectives.
