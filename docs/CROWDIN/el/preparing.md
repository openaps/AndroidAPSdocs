...
##### [ρωτήστε την ομάδα μας στο facebook](https://www.facebook.com/groups/AndroidAPSUsers/)

##### [ρωτήστε το κανάλι του discord](https://discord.com/channels/629952586895851530/629954570394533889)
...
Αυτό το κεφάλαιο εξηγεί τη συμβατότητα του AAPS με τα CGMs (Συνεχής Παρακολούθηση της Γλυκόζης) και τις αντλίες ινσουλίνης. Επίσης, παρέχει έναν οδηγό για τη σωστή κατασκευή ενός συστήματος AAPS προκειμένου να εξασφαλίσουμε ότι λειτουργεί σωστά στην καθημερινή ζωή.

#### [How to build and install AAPS](Installing-AndroidAPS/Building-APK.md)

Αυτή η ενότητα είναι τα βήματα για την κατασκευή του AAPS. Strict adherence to the step-by-step instructions are required in order to successfully build **AAPS**.  Please take your time.
...
Αυτή η ενότητα εξηγεί πώς να ρυθμίσετε τα στοιχεία "Προφίλ", "Πηγή δεδομένων γλυκόζης", "Ανίχνευση ευαισθησίας", " APS", "Loop", "Θεραπείες".
...
#### [Αντιμετώπιση προβλημάτων](Usage/troubleshooting.md)
...
#### [Γλωσσάριο](Getting-Started/Glossary.md)
...
| Στόχος 1: Δημιουργία οπτικοποίησης και παρακολούθησης, ανάλυση βασικού δεδομένων και αναλογιών |     1 hour      |
