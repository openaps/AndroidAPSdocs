...
* [Dexcom App (patched)](https://github.com/dexcomapp/dexcomapp/) - Select 'Send BG data to xDrip+' if you want to use xDrip+ alarms. ![Διαμόρφωση BG πηγή](../images/ConfBuild_BGSource.png)
