...
Εάν δείτε την παραπάνω προειδοποίηση μετά τη χρήση του οδηγού bolus, το AndroidAPS ανίχνευσε ότι η υπολογισμένη τιμή COB ίσως είναι εσφαλμένη. Επομένως, εάν θέλετε να κάνετε bolus ξανά μετά από ένα προηγούμενο γεύμα με COB, θα πρέπει να μην ξεχνάτε την υπερβολική δόση! Για λεπτομέρειες, δείτε τις συμβουλές στη σελίδα [ υπολογιστής COB ](../Usage/COB-calculation.html#detection-of-wrong-cob-values).
...
Αυτά είναι απλώς ημερολόγια θεραπειών (boluses και carbs), μηνύματα xDrip και μηνύματα που αποστέλλονται στη Nightscout μέσω του ενσωματωμένου πελάτη Nightscout. Συνήθως δεν χρειάζεται να ανησυχείτε για κανένα από αυτά εκτός αν υπάρχει κάποιο πρόβλημα.
