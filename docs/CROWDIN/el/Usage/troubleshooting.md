...
### Ρυθμίσεις
* [Προφίλ](Profiles-troubleshooting-profile-errors)
...
* [Γενικά](GeneralCGMRecommendation-troubleshooting)
...
* [Accu-Check Insight](Accu-Chek-Insight-Pump-insight-specific-errors)
