...
**BG source** where your blood glucose values come from. הם מגיעים מחיישני CGM או FGM שאתם קוראים בעזרת תוכנת אינטגרציה כמו BYODA, +xDrip וכו'. [Wiki - BG source](../Configuration/Config-Builder.md#bg-source) → see also **CGM / FGM**
...
**LGS** Low Glucose Suspend - AAPS will reduce basal if blood glucose is dropping. אם רמת הסוכר בדם עולה אז היא תעלה רק אם ה-IOB שלילי (מ-LGS קודם), אחרת המינונים הבזאליים יישארו זהים לפרופיל שבחרתם. ייתכן שתחוו קפיצות בסוכר לאחר טיפול בהיפוגליקמיות באופן זמני בגלל שאין עליה במינון הבזאלי לאחר היציאה מהיפוגליקמיה. → see also [objective 6](../Usage/completing-the-objectives.md#objective-6-starting-to-close-the-loop-with-low-glucose-suspend)
