...
After setting the sensor, the transmitter can be clicked into the sensor holder. זהירות! First click in the square side and then press down the round side.
