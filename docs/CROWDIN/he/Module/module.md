...
AndroidAPS הוא לא רק יישום (בבניה עצמית), הוא רק אחד ממספר מודולים של מערכת הלולאה הסגורה שלכם. לפני שמחליטים על רכיבים, יהיה זה רעיון טוב לעיין גם ב'הגדרת הרכיבים \<../index#component-setup>'\_.
