...
![דפדפן היסטוריה](../images/Maintenance/historybrowser.png)

Select the date you want to review.

![דפדפן היסטוריה](../images/Maintenance/historybrowser2.png)

Display options are available like in the Overview main graph.

![דפדפן היסטוריה](../images/Maintenance/historybrowser3.png)
...
![דפדפן היסטוריה](../images/Maintenance/historybrowser4.png)
...
![דפדפן היסטוריה](../images/Maintenance/historybrowser5.png)

To return to real time select this button:

![דפדפן היסטוריה](../images/Maintenance/historybrowser6.png)
