...
**AAPS is not available as download due to regulation for medial devices. It is legal to build the app for your own use but you must not give a copy to others! ראו [שאלות נפוצות](../Getting-Started/FAQ.md) לפרטים.**
