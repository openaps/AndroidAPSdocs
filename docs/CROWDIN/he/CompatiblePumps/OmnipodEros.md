...
- **שגיאות:** מציג את השגיאה האחרונה. Review the [Pod history](#view-pod-history), [RileyLink history](#rileylink-and-active-pod-history) and log files for past errors and more detailed information.
