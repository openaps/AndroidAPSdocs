...
**AAPS**是一個運作在 Android 智慧型手機和裝置上的應用程式。 您將使用逐步指南自己構建**AAPS**應用程式（apk 檔案），從 GitHub 下載**AAPS**源代碼，並在您的電腦上安裝所需程式（Android Studio、GitHub 桌面版），以構建自己的**AAPS**應用程式副本。 然後，您將透過電子郵件、USB 線等方式將**AAPS**應用程式傳輸到您的智慧型手機並安裝。
