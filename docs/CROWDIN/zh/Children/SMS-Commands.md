...
- 大多數暫時目標的調整、跟隨 AAPS 等操作可以在連線網路的 Android 手機上的 [AAPSClient 應用程式](../Children/Children.md) 中完成。
...
- 幫浦 \* 回覆：上次連線：1 分鐘前，臨時基礎率：0.00U/h @11:38 5/30分鐘，體內胰島素：0.5U，儲量：34U，電池：100
- 幫浦連線 \* 回覆：幫浦已重新連線
