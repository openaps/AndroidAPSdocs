# Полномасштабный замкнутый цикл

## Полномасштабный замкнутый цикл против гибридного (FCL vs HCL)
...
AAPS также имеет режим **полномасштабного замкнутого цикла без подачи пользователем каких-либо болюсов** и без ввода углеводов в режиме, называемом UAM = необъявленный приём пищи (UAM).
