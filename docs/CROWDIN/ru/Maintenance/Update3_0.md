...
To resolve this issue go to [config builder](../SettingUpAaps/ConfigBuilder.md#pump). Переключите помпу на виртуальную и вернитесь на реальную. Состояние помпы будет сброшено.
