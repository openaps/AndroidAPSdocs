...
- Если алгоритм цикла запрашивает отмену текущей временной скорости базала TBR, Combo на 15 минут установит TBR в 90% или 110%. This is because cancelling a TBR causes an alert on the pump which causes a lot of vibrations.
