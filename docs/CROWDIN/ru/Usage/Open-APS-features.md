...
SMB работает всегда (независимо от активных углеводов COB, временных целей или болюсов). По соображениям безопасности, эта опция возможна только для источников ГК с хорошей системой фильтрации зашумленых данных. На данный момент он работает с Dexcom G5 или G6, с ['Самостоятельно построенным приложением Dexcom BYODA'](../Hardware/DexcomG6.html#if-using-g6-with-build-your-own-dexcom-app) или c 'нативным режимом' в xDrip+. Если значение ГК имеет слишком большое отклонение, G5/G6 не отправляет его и ожидает следующего значения через 5 минут.
...
SMB работает в течение 6 часов после приема углеводов, даже если активные углеводы COB находятся на 0. По соображениям безопасности, эта опция возможна только для источников ГК с хорошей системой фильтрации зашумленых данных. На данный момент он работает с Dexcom G5 или G6, с ['Самостоятельно построенным приложением Dexcom BYODA'](../Hardware/DexcomG6.html#if-using-g6-with-build-your-own-dexcom-app) или c 'нативным режимом' в xDrip+. Если значение ГК имеет слишком большое отклонение, G5 не отправляет его и ожидает следующего значения через 5 минут.
