...
- But you can also make use one of the average deltas. Сравнивая дельты в условиях Автоматизации, можно определять действия с разным приоритетом в зависимости от того, как быстро повышается уровень глюкозы.
