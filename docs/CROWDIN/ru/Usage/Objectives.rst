...
* Неотвеченные вопросы повлияют только в том случае, если вы начинаете новую цель. In other words: If you have already completed all objectives you can wait and answer the new questions later without loosing AAPS functions.
