...
- Для использования [Automation](../Usage/Automation.md) начните Цель 10.
...
Одна из целей была удалена после выхода Android APS 3.0.  Пользователи Android APS версии 2.8.2.1, которые находятся на старой версии Android ( до версии 9) будет использоваться более старый набор целей, которые можно найти [здесь](../Usage/Objectives_old.md).
