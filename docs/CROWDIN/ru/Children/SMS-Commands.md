...
![Настройка SMS команд](../images/SMSCommandsSetup.png)
...
- Если вы хотите использовать более одного номера:
  ...
  - Введите дополнительные номера, разделенные точкой с запятой, без пробела.
    ...
    ![Команды SMS с нескольких номеров](../images/SMSCommandsSetupSpace2.png)
...
![Пример команд SMS](../images/SMSCommands.png)
...
![Отключить SMS как сообщение чата](../images/SMSdisableChat.png)
