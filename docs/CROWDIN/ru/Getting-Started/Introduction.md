...
Не принимайте ингибиторы SGLT-2 (глифлозины) при использовании **AAPS**, поскольку они непредсказуемо снижают уровни сахара в крови. Combining this effect with a system that lowers basal rates in order to increase BG is dangerous, there is more detail about this in the main [safety section](../preparing.md#safety-first).
...
Хотите узнать, как начать работу с AAPS? Take a look at the [preparing](../preparing.md) section.
