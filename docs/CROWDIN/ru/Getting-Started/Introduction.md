...
**AAPS** предоставляет людям, которые в настоящее время не могут позволить себе или не имеют финансирования/страховки, доступ к гибридной системе замкнутого цикла мирового класса. которая концептуально на годы опережает коммерческие системы, предлагаемые клиниками. Вам нужно иметь аккаунт Nightscout для настройки **AAPS**, хотя аккаунт Nightscout не требуется для повседневной работы с циклом **AAPS**. Многие продолжают использовать Nightscout для сбора данных и дистанционного управления. Таким образом, хотя **AAPS** сам по себе бесплатен, создание Nightscout может повлечь за собой периодические платежи (0 - 12 евро), в зависимости от уровня поддержки (см. таблицу). **AAPS** работает с большим ассортиментом недорогих телефонов на Android (ценой от 150 евро). Different versions are available for specific locations and languages, and AAPS can also be used by people who are [blind](#accessibility-for-users-aaps-who-are-partially-or-completely-blind).

#### 9) **Support**
Ни одна из автоматизированных систем введения инсулина не является совершенной. Коммерческие системы и системы с открытым исходным кодом имеют много общих недоработок как в коммуникациях, так и в оборудовании. There is support available from community of AAPS users on Facebook, Discord and GitHub who designed, developed and are currently using **AAPS**, all over the world. Существуют также группы поддержки Facebook и помощь от коммерческих компаний для коммерческих систем APS - можно общаться с пользователями или бывшими пользователями этих систем на темы общих неполадок, качестве обучающих программ и уровня поддержки.
...
| ПОМПА          | [Roche Combo](../CompatiblePumps/Accu-Chek-Combo-Pump.md)              | ![доступный](../images/available.png)     | ![недоступный](../images/unavailable.png)             | ![недоступный](../images/unavailable.png)                         | ![недоступный](../images/unavailable.png)      |
...
Не принимайте ингибиторы SGLT-2 (глифлозины) при использовании **AAPS**, поскольку они непредсказуемо снижают уровни сахара в крови. Combining this effect with a system that lowers basal rates in order to increase BG is dangerous, there is more detail about this in the main [safety section](../Getting-Started/PreparingForAaps.md#safety-first).
...
Хотите узнать, как начать работу с AAPS? Take a look at the [preparing](../Getting-Started/PreparingForAaps.md) section.
