...
Если у вас уже есть более ранняя сборка AndroidAPS, НЕ создайте новый файл ключей, выберите существующий!
:::
...
:::{admonition} ВНИМАНИЕ!
:class: предупреждает
Запишитете эти пароли! Они понадобятся при создании следующего обновления AndroidAPS!
:::
