...
5. `Импортируйте настройки <../Usage/ExportImportSettings.html>`__
...
3. Постройте приложение с нуля, как описано `здесь <../Installing-AndroidAPS/Building-APK.html#download-code-and-additional-components>`__.
