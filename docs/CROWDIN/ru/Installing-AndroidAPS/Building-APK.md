...
* Используйте **[ Android Studio версии 2022.3.1 ](https://developer.android.com/studio/)** или новее для построения apk.
* [Windows для 32-разрядных систем](troubleshooting_androidstudio-unable-to-start-daemon-process) не поддерживаются в Android Studio
...
6. [Соберите приложение ](Building-APK-generate-signed-apk) (сгенерируйте подписанный apk)
