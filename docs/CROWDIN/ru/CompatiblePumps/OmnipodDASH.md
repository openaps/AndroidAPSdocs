...
This section covers common workarounds and settings that need to be changed to enable a feature to work around a community reported issue that has a fix. Например, the Basal drift enable process is documented here.
