...
* AndroidAPS'nin %200'ün üzerinde bazal orana izin vermesini istiyorsanız, >%200 için yayma bolus kullan'ı etkinleştirin. Note this means you cannot loop with high TBRs whilst using extended boluses for food.
