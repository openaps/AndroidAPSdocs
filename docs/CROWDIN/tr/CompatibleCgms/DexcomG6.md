...
- Pre-soaking of the G6/ONE with factory calibration is likely to give variation in results. 'pre-soak' ön ısınma yapıyorsanız, en iyi sonuçları almak için muhtemelen sensörü kalibre etmeniz gerekecektir.
