...
4. (gelişmiş, [Görev 9](../Usage/Objectives#objective-9-enabling-additional-oref1-features-for-daytime-use-such-as-super-micro-bolus-smb)): AKRB (Aktif karbonhidrat) > 0 ve "SMB'yi her zaman etkinleştir" seçili ise OpenAPS SMB etkin olsa bile, “Yüksek geçici hedeflerle SMB'yi etkinleştir"i devre dışı bırakarak geçici hedefler etkinken AndroidAPS'in SMB'leri vermesini engelleyebilirsiniz. 
