...
**BG source** where your blood glucose values come from. BYODA, xDrip+ vb. gibi bir tür entegrasyon yazılımı aracılığıyla taktığınız bir CGM veya FGM sisteminden gelirler. [Wiki - BG source](../Configuration/Config-Builder.md#bg-source) → see also **CGM / FGM**
