...
Bir profil değiştir'me ile kolayca yeni bir yerel profil oluşturabilirsiniz. In this case timeshift and percentage will be applied to the new local profile.
