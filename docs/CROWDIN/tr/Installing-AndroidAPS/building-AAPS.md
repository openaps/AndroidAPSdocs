...
### Android Studio tercihlerinde git yolunu ayarlayın
...
Your file manager/explorer will open. "full" (1) > "release" (2) dizinine gidin.
...
Tebrikler! Now you have built the **AAPS** apk file, you can move to the next stage of [Transferring and Installing **AAPS**](Transferring-and-installing-AAPS.md).
