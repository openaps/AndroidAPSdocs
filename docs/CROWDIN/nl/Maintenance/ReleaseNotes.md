...
Please follow the instructions in the [update manual](UpdateToNewVersion). Daar vind je ook oplossingen voor veelvoorkomende problemen.

Zodra een nieuwe update beschikbaar is zie je de volgende melding:

![Update info](../images/AAPS_LoopDisable90days.png)

Dan heb je 60 dagen om bij te werken. If you do not update within these 60 days AAPS will fall back to LGS (low glucose suspend - see [glossary](../UsefulLinks/Glossary.md)) as in [objective 6](../SettingUpAaps/CompletingTheObjectives.md#objective-6-starting-to-close-the-loop-with-low-glucose-suspend).
...
- Treatment buttons: old treatment button still available, but hidden by default. Je kunt zelf aangeven welke knoppen zichtbaar zijn. New insulin button, new carbs button (including [eCarbs/extended carbs](../DailyLifeWithAaps/ExtendedCarbs.md))
