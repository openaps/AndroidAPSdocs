...
* Op dit moment worden alleen basaal standen tussen de 0.05 en 10 E/uur ondersteund. This also applies when modifying a profile, e.g. when increasing to 200%, the highest basal rate must not exceed 5 U/h since it will be doubled. Dit geldt ook voor de ondergrens: bij een verlaging tot 50% moet de laagste basaalstand minstens 0,10 E/uur zijn.
...
9. Bij de volgende Pomp sessie moet een beveiligingscode van 10 cijfers verschijnen. En Ruffy een scherm om in te voeren. So enter it in Ruffy and you should be ready to go.
