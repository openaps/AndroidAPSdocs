...
<tr>
 <td>OpenAPS</td>
 <td>open kunstmatige alvleesklier systeem (Open Artificial Pancreas System).<br>APS uitgevoerd op kleine computers (zoals Raspberry Pie of Edison).<br>AAPS gebruikt meerdere OpenAPS functies</td>
 <td>&nbsp;</td>
