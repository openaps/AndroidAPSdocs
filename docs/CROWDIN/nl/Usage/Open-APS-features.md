...
Wees voorzichtig en geduldig en verander de instellingen stap voor stap. Het is voor iedereen anders en hangt ook af van jouw gemiddelde totale dagdosis (TDD). Om veiligheidsredenen is er ook hier een grens, die afhangt van de leeftijd van de patiënt. De 'harde limiet' voor max-IOB is hoger dan in AMA.
...
**Gebruik altijd kleine gemiddelde verschillen ipv gewone verschillen** Wanneer je deze functie inschakelt, dan gebruikt AndroidAPS het kleine gemiddelde (= gemiddelde vd afgelopen 15 minuten), wat meestal het gemiddelde is van de afgelopen drie waardes. Dit helpt AndroidAPS om stabieler te werken met bloedglucose bronnen met veel ruis, zoals xDrip+ en Libre.
...
Standaard waarde: 3 (mag niet worden gewijzigd, tenzij je het echt wilt en weet wat je doet)
...
Standaard waarde: 4 (mag niet worden gewijzigd, tenzij je het echt wilt en weet wat je doet)
...
**Je moet [Doel 7](../Usage/Objectives.md) hebben afgerond om AMA te kunnen gebruiken.**
...
De standaardinstelling is 2, je moet deze waarde in kleine stapjes ophogen om te zien wat de invloed is en welke waarde het beste bij jou past. Het is voor iedereen anders en hangt ook af van jouw gemiddelde totale dagdosis (TDD). Om veiligheidsredenen is er ook hier een grens, die afhangt van de leeftijd van de patiënt. De 'harde limiet' voor max-IOB is lager bij MA dan bij SMB.
