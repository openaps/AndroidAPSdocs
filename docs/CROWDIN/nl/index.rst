...
* Een Android smartphone met Android 5.0 of hoger. **Please update to Android 6 or higher as it is planned to drop support for Android 5.x soon.**
  Zie `dit werkblad <https://docs.google.com/spreadsheets/d/1gZAsN6f0gv6tkgy9EBsYl0BQNhna0RDqA9QGycAqCQc/edit?usp=sharing>`_ voor ervaringen van anderen hoe goed een telefoon met AndroidAPS werkt.
