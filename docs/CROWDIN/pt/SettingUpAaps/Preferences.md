...
- In the example below you see the prompt for biometric protection. Se a autenticação biométrica não funcionar, clique no espaço acima do prompt branco e digite a palavra-passe mestre.
...
- [Bomba de Insulina Accu Chek Combo](../CompatiblePumps/Accu-Chek-Combo-Pump.md)
...
![ClienteNS](../images/Pref2020_NSClient.png)
