...
* In the menu, go to File > Settings.
    ...
    ![Abrir definições](../images/studioSetup/30_Settings.png)
...
* Tick the box left of "Android 9.0 (Pie)" (4) (API Level 28).
    ...
    ![Definições do SDK](../images/studioSetup/31_AndroidSDK.png)

* Confirme as alterações clicando em OK.
    
    ![Confirmar alterações do SDK](../images/studioSetup/32_ConfirmSDK.png)

* Accept licence agreement (1) and click "Next" (2).
    
    ![Aceitar Licença SDK](../images/studioSetup/33_ConfirmLicense.png)

* Wait until the SDK download and installation is finished.
    
    ![Esperar durante a instalação do SDK](../images/studioSetup/34_DownloadSDK.png)

* Quando a instalação do SDK for concluída o botão "Finish" ficará azul. Clique neste botão.
    
    ![Finalizar a instalação do SDK](../images/studioSetup/35_DownloadSDKfinished.png)

* O Android Studio pode recomendar para atualizar o "gradle system". **Never update gradle!** This will lead to difficulties!
