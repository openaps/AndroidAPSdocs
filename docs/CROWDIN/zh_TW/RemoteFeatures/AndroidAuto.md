...
* 如果你沒有看到通知，請檢查你是否[允許 AAPS 顯示通知](#use-system-notifications-in-aaps-for-alerts-and-notifications)，並檢查[Android Auto 是否有權限存取通知](#allow-the-use-of-unknown-sources-with-android-auto)。