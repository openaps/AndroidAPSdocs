...
- 此外，可以在相容的智慧型手錶上構建並安裝[AAPS WearOS 應用程式](../WearOS/WearOsSmartwatch.md)，該手錶連接到孩子的手機，但由家長佩戴。 這包括上述所有功能，並具有注射胰島素的能力。 This allows the parent to administer insulin without needing to remove the kid's phone from however it is kept on them.
