...
如果運行 AAPS 的裝置壞了或與幫浦超出範圍，一旦最新的臨時基礎結束，幫浦會恢復為標準幫浦，運行預設的基礎速率。
...
這主要在對 AAPS 的運作方式進行高階總覽。 有關更多詳細資訊，請諮詢你的患者，聯繫社群，或閱讀線上提供的 AAPS 完整文件。
