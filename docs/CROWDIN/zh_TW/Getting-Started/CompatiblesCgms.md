...
| [Dexcom ONE+](../CompatibleCgms/DexcomG7.md)                            | [xDrip+](../CompatibleCgms/xDrip.md) 或 [Juggluco](../CompatibleCgms/Juggluco.md)                         |
...
| [Caresens](../CompatibleCgms/Caresens.md)，Simplera，iCan，LinX，SmartGuide | xDrip+ 配套 App 或 [Juggluco](../CompatibleCgms/Juggluco.md)                                                |
...
為了讓**AAPS**正確識別它們，發送**血糖**讀取的應用程式必須能提供傳感器資訊。
...
| Dexcom ONE+      |              xDrip+（**直連、原生**），</br>Juggluco（**透過 xDrip 廣播**，不需安裝 xDrip+）              |
