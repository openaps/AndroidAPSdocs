...
為1型糖尿病患者開發商業技術的進度非常緩慢。 在2013年，1型糖尿病社群發起了#WeAreNotWaiting運動。 他們使用現有的認證技術（胰島素幫浦和傳感器）自行開發系統，以改善血糖控制、安全性和生活品質。 這些被稱為 OS-AID（開源自動化胰島素劑量）系統（先前稱為 DIY 系統），因為它們未獲衛生機構（如 FDA、NHS 等）正式核准。 目前有四個主要的 DIY 系統可用：[OpenAPS](https://openaps.org/what-is-openaps/)、**AAPS**、[Loop](https://loopkit.github.io/loopdocs/#what-is-loop) 和 [Trio](https://triodocs.org)。
...
目前已經有幾個商業混合閉環系統問世，其中最新的是 [CamAPS FX](https://camdiab.com/)（英國和歐盟）和 [Omnipod 5](https://www.omnipod.com/en-gb/what-is-omnipod/omnipod-5)（美國和歐盟）. 這些與 OS-AID 系統非常不同，主要因為它們都包含「學習演算法」，會根據你前幾天的胰島素需求來調整輸送的胰島素量。 OS-AID 社群中的許多人已經嘗試過這些商用系統，並與他們的 OS-AID 系統加以比較。 你可以透過專門針對這些系統的Facebook群組進一步了解各系統之間的比較，參考 [AAPS Facebook群組](https://www.facebook.com/groups/AndroidAPSUsers/) 或在 [Discord](https://discord.com/invite/4fQUWHZ4Mw) 上詢問。
...
截至 2023 年 6 月 25 日，目前有四個主要的開源閉環系統可用：[OpenAPS](https://openaps.readthedocs.io/)、**AAPS**、[Loop](https://loopkit.github.io/loopdocs/#what-is-loop) 和 [Trio](https://triodocs.org)（先前稱為 FreeAPS X）。 下表顯示了不同系統的特性：
...
_表格說明：_
1. 一個 **設備** 是一個隨身攜帶的小型電腦，沒有顯示螢幕。 支援的設備類型包括Intel Edison + Explorer Board，另一種是Raspberry Pi + Explorer HAT或Adafruit RFM69HCW Bonnet。 最早的APS系統基於這樣的設置，因為當時的手機無法運作所需的演算法。 隨著手機設置變得更簡單，並且手機內建顯示螢幕，這些系統的使用已經減少。 Intel也已經停止銷售Intel Edison。 優秀的 OpenAPS 演算法 **oref0** 與 **oref1** 現已整合進 AAPS 與 Trio。
