...
* **綠色**長條圖顯示血糖高於演算法預期。 Green bars are used to increase resistance in [Autosens](KeyAapsFeatures#autosens).
* **紅色**長條圖顯示血糖低於演算法預期。 Red bars are used to increase sensitivity in [Autosens](KeyAapsFeatures#autosens).
