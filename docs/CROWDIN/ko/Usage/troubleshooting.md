...
### Settings
* [프로파일](../Usage/Profiles.md#troubleshooting-profile-errors)
...
* [포괄적인 정보](../Hardware/GeneralCGMRecommendation.md#troubleshooting)
...
* [DanaRS(다나알에스)](../Configuration/DanaRS-Insulin-Pump.md#dana-rs-specific-errors)
...
* [Accu-Chek Insight (아큐첵 인사이트)](../Configuration/Accu-Chek-Insight-Pump.md#insight-specific-errors)
