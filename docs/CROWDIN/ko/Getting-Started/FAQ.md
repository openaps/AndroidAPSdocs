...
아니오. There is no downloadable apk file for AAPS. 본인 스스로 파일을 [빌드](../Installing-AndroidAPS/Building-APK.md)해야만 합니다. 그 이유는 다음과 같습니다:
...
### AAPS NSClient says 'not allowed' and does not upload data. 어떻게 해야 하나요?
