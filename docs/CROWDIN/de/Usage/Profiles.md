...
It is always a question of which hour’s **Profile’s** settings should replace the settings of the current time. Diese Uhrzeit muss um x Stunden verschoben werden. So please be mindful of the directions as described in the following example:
