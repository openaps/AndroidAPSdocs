...
* Dein Sourcecode ist jetzt die aktuelle veröffentlichte Version. Es ist nun Zeit, die signierte APK-Datei zu erstellen. Die Informationen dazu findest Du in der [Anleitung zum erstmaligen Erstellen](../Installing-AndroidAPS/Building-APK.html#signierte-apk-erstellen-generate-signed-apk).

## 4. Übertrage die APK-Datei

Du musst die APK-Datei auf Dein Smartphone übertragen, um sie dort installieren zu können. Hinweise dazu findest Du auf der Seite ['Übertrage die APK-Datei auf das Smartphone'](../Installing-AndroidAPS/Building-APK.html#ubertrage-die-apk-datei-auf-das-smartphone)
