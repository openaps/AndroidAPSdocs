...
Aus einem Profilwechsel kannst Du ganz einfach ein neues lokales Profil erstellen. In this case, timeshift and percentage will be applied to the new local profile. Use the **Clone** button shown on line **1**.
