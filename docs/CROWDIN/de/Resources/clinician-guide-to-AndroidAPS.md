...
* Organisieren Sie sich eine [kompatible Insulinpumpe](../Hardware/pumps.rst), ein [kompatibles Android-Gerät](https://docs.google.com/spreadsheets/d/1gZAsN6f0gv6tkgy9EBsYl0BQNhna0RDqA9QGycAqCQc/edit?usp=sharing) und eine [kompatible CGM Quelle](https://androidaps.readthedocs.io/en/latest/EN/index.html#getting-started).
