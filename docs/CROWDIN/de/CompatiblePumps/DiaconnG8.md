...
- [Diese Seite](#Extended-Carbs-why-extended-boluses-won-t-work-in-a-closed-loop-environment) erklärt die Details, warum der Extended-Bolus in einem Closed-Loop-Umfeld nicht funktioniert.
