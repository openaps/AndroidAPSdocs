...
<img src="../images/SampleSetupSmartwatch.png" width="150" /> Details about the information displayed on the watchface can be found [here](../Configuration/Watchfaces.md).
