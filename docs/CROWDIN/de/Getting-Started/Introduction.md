...
SGLT-2 Inhibitoren (Gliflozine) sollten bei der Verwendung von **AAPS** nicht eingenommen werden, da sie den Blutzuckerspiegel unberechenbar senken. Combining this effect with a system that lowers basal rates in order to increase BG is dangerous, there is more detail about this in the main [safety section](../preparing.md#safety-first).
...
Interessiert, wie Du mit der Einrichtung von AAPS beginnst? Take a look at the [preparing](../preparing.md) section.
