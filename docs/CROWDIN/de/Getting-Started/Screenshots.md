...
Um eines davon zu verändern, drücke länger auf das entsprechende Feld. I.e long press the target bar in the upper right ("100" in the screenshot above) to set a temp target.
