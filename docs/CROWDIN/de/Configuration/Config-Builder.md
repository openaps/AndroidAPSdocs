...
* [Dexcom G5 app (patched)](https://github.com/dexcomapp/dexcomapp/) - Select 'Send BG data to xDrip+' if you want to use xDrip+ alarms. ![Konfigurations-Generator - BZ-Quelle](../images/ConfBuild_BGSource.png)
