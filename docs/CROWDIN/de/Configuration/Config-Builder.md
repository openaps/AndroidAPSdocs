...
Du kannst Änderungen am Profil im Nighscout Profil-Editor mit Deinen lokalen Profilen synchronisieren. The settings can be found in [NSClient preferences](../Configuration/Preferences.md#nsclient).
