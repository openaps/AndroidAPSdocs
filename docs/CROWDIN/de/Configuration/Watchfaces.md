...
* Nutze das **Dark theme** des AAPS Watchfaces und **Matching divider**. Auf OLED-Geräten wird die Anzahl der Pixel, die beleuchtet werden, begrenzt und der Burnout begrenzt.
