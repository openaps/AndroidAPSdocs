...
* **Kompatibles Android Smartphone** mit Bluetooth-Verbindung (Bluetooth Low Energy, BLE)
   ...
   - **Wichtiger Hinweis: Es gab mehrere Fälle von dauerhaften, nicht wiedergutzumachenden Verbindungsverlusten bei der Verwendung von Android 12 zusammen mit Pods mit Firmware Version 3.XX.X. Vermeide die Nutzung von Android 12 mit diesen alten Pod-Firmware Versionen vorerst!**  
