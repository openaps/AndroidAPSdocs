...
* Basalraten werden nur im Bereich von 0,05 bis 10 IE/h unterstützt. This also applies when modifying a profile, e.g. when increasing to 200%, the highest basal rate must not exceed 5 U/h since it will be doubled. bzw. minimal 0,1 iE/h (da nach Halbierung 0,05 iE/h).
...
9. Danach sollte die Pumpe einen 10-stelligen Sicherheitscode anzeigen. Und ruffy einen Dialog, um ihn einzugeben. So enter it in Ruffy and you should be ready to go.
