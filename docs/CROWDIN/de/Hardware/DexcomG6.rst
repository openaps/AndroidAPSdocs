...
* Wenn es nicht bereits installiert ist, dann lade `xDrip+ <https://github.com/NightscoutFoundation/xDrip>`_ herunter und folge den Anweisungen auf `xDrip+ Einstellungen <../Configuration/xdrip.html>`_.
...
--------------------------------------------------
Falls Du einen Transmitter bei einer laufenden Sensorsitzung wechseln musst, kannst Du versuchen, den Transmitter zu tauschen, ohne die Transmitterhalterung zu beschädigen. Ein Video findest Du unter `https://youtu.be/tx-kTsrkNUM <https://youtu.be/tx-kTsrkNUM>`_.
