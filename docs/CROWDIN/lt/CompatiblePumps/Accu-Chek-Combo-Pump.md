...
- Šiuo metu kitų sprendimų ryšio problemoms nėra. So if you see those errors frequently your only option at this time is to get another phone that's known to work well with AAPS and the Combo (see above).
