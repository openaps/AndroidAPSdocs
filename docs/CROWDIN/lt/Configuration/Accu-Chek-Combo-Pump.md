...
* Šiuo metu yra palaikomi baziniai greičiai nuo 0.05 iki 10 vv/h. This also applies when modifying a profile, e.g. when increasing to 200%, the highest basal rate must not exceed 5 U/h since it will be doubled. Analogiškai, kai reikia sumažinti iki 50%, mažiausias bazinis greitis turi būti bent 0.10 vv/h.
...
9. Toliau pompa parodys iki 10 ženklų saugos kodą. Ir Ruffy programos ekraną, kad jį įvestumėte. So enter it in Ruffy and you should be ready to go.
