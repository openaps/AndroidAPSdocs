...
Eikite į AAPS NSClient skirtuką ir žiūrėkite žurnalą. The expected behavior is to receive a PING every ~30s and almost no reconnection messages. If you see many reconnections, then there is a problem.
