...
Ne. There is no downloadable apk file for AAPS. You have to [build](../Installing-AndroidAPS/building-AAPS.md) it yourself. Štai priežastis, kodėl:
...
### AAPSClient says 'not allowed' and does not upload data. Ką aš galiu padaryti?
