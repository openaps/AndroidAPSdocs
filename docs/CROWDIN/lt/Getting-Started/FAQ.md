...
Ne. There is no downloadable apk file for AAPS. Jūs turite [sukurti](../Installing-AndroidAPS/Building-APK.md) jį patys. Štai priežastis, kodėl:
...
### AAPS NSClient says 'not allowed' and does not upload data. Ką aš galiu padaryti?
