...
Bienvenido. This documentation aims to guide users who are preparing to setup and start using the Android Artificial Pancreas System (**AAPS**).
...
| Objetivo 1: Establecimiento de la visualización y la supervisión, análisis de las basales y las tasas |     1 hour      |
| Objective 2: Learn how to control AAPS                                                                |     2 hour      |
| Objetivo 3: Demuestra tus conocimientos                                                               |  Up to 14 days  |
| Objetivo 4: Iniciar en un lazo abierto                                                                |     7 days      |
| Objetivo 5: Comprensión de su lazo abierto, incluidas sus recomendaciones basales temporales          |     7 days      |
| Objetivo 6: Empezando a cerrar el lazo con Baja Glucosa Suspender                                     | Up to 5-14 days |
| Objective 7: Tuning the closed loop, raising maxIOB and gradually lowering BG targets                 |  Up to 7 days   |
| Objetivo 8: ajustar las basales y proporciones si es necesario, y luego habilitar el autosensado      | Up to 7-14 days |
