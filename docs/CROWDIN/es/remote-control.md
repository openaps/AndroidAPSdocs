...
![imagen](images/remote_control_and_following/AAPS_overview_remote_control_01.png)
...
**AAPSClient** can be installed on a single phone or multiple follower phones (_i.e._ parent 1’s follower phone and parent 2’s follower phone) in order for both caregivers to be granted access and remote control a patient's **AAPS** phone.
...
![imagen](images/remote_control_and_following/AAPSClient_download_02.png)

Then go to  _downloads_ on your computer. On Windows, -downloads_ will show the right hand ribbon:

![imagen](images/remote_control_and_following/AAPSClient_download_folder_03.png)
...
![imagen](./images/67fd75f3-721c-438d-be01-1a8e03532290.png)
...
![imagen](./images/6d787373-bc0c-404d-89aa-54d3127c4a6f.png)

![imagen](./images/5d2feecc-3f10-4767-b143-1a72da2b9bd4.png)
...
![imagen](./images/e8e3b7f3-f82e-425a-968c-cc196434a5f8.png)

To get back here:

![imagen](./images/37f4589c-6097-49d4-b0b9-087664914198.png)
...
![imagen](./images/b2cccc84-85b6-4ee1-800b-7c6dcb9dd857.png)


Go to Build > Generate Signed Bundle / APK


![imagen](./images/f488fe36-8cb9-4d81-9d94-5f742a1aaaee.png)

Select > APK:

![imagen](./images/Installation_Screenshot_39b.PNG)


Select in Module: AndroidAPSwear

![imagen](./images/cceaa832-70e6-4ad5-95ec-a82e2a6add1e.png)
...
![imagen](./images/87ce7943-256e-449e-8439-8f9fd5bef05e.png)
...
##### Using Wear Installer 2 to side-load **AAPS** Wear from the phone onto the watch
 ...
 ![imagen](./images/43577a66-f762-4c11-a3b3-4d6d704d26c7.png)
...
![imagen](./images/81ceb8f3-dfa6-468b-b9d0-c31b885bc104.png)
...
![imagen](./images/b927041f-cc53-4cde-9f77-11cd517c9be0.png)


![imagen](./images/00b2fb8b-5996-4b71-894e-516d63469e1b.png)
...
![imagen](./images/d1bc4c9d-d5ef-4402-a9a2-a51ed242eff3.png)


 Next step > accept the authorisation request on the smartwatch


![imagen](./images/2c398a34-b865-4aa1-9c53-d83dfef052a7.png)
...
![imagen](./images/2308c075-f41c-45bc-9c0f-3938beeaaafb.png)


Then "save as" and save the file to a convenient location on your computer:


![imagen](./images/bcf63cbc-9028-41d5-8416-fa2a31fd6f7d.png)
