...
> 
> When using **ICR** the amount of insulin is fixed and the amount of carbs is variable. ("¿Cuántos gr de carbohidratos pueden estar cubiertos por una sola unidad de insulina?")
> 
> Example:
> 
