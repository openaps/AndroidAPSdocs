...
![imagen](../images/remote-control-25b.png)
...
| **Cambio de perfil**                                      | Allows you to check the current profile which is running,<br>and switch to another profile, either permanently,<br>or for a defined length of time (mins).                                                                                    |
