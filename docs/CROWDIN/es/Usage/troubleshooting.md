...
* [Perdida de almacén de claves](../Installing-AndroidAPS/troubleshooting_androidstudio.md#lost-keystore)
* [Troubleshooting AndroidStudio](../Installing-AndroidAPS/troubleshooting_androidstudio.html)

### Configuración
* [Perfil](../Usage/Profiles.md#troubleshooting-profile-errors)
