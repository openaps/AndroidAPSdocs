...
-   La preabsorción del G6 con calibración de fábrica es probable que dé variaciones en los resultados. If you do pre-soak, then to get best results, you will probably need to calibrate the sensor.
...
-   Para usar xDrip+ como receptor, desinstala primero la aplicación Dexcom. **You cannot connect xDrip+ and Dexcom app with the transmitter at the same time!**
