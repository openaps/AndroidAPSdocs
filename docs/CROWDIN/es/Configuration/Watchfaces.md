...
AndroidAPS is designed to be *controlled* by Android Wear watches. Si desea bolo etc. desde el reloj entonces dentro de "Configuración de Reloj" que necesitas para activar "Controles desde el Reloj".
