...
- Pre-soaking of the G6/ONE with factory calibration is likely to give variation in results. Si haces preconfiguración, entonces para obtener los mejores resultados, probablemente necesitarás calibrar el sensor.
