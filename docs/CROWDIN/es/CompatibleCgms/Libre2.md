...
- Descarga e instala la aplicación Juggluco desde [aquí](https://www.juggluco.nl/Juggluco/download.html).
...
For legal reasons, "patching" has to be done by yourself. Utilizar motores de búsqueda para encontrar los enlaces correspondientes. There are two variants: The recommended original patched app blocks any internet traffic to avoid tracking. The other variant supports LibreView.
