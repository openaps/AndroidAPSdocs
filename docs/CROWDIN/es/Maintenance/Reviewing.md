...
![Historial](../images/Maintenance/historybrowser.png)

Select the date you want to review.

![Historial](../images/Maintenance/historybrowser2.png)

Display options are available like in the Overview main graph.

![Historial](../images/Maintenance/historybrowser3.png)
...
![Historial](../images/Maintenance/historybrowser4.png)
...
![Historial](../images/Maintenance/historybrowser5.png)

To return to real time select this button:

![Historial](../images/Maintenance/historybrowser6.png)
