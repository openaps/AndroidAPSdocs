...
## Install AndroidAPS
1. Follow the instructions to [build the APK](../Installing-AndroidAPS/Building-APK.md) (*on the linked page select 'Generate signed APK' in the navigation on the left*)
2. [Transfer](../Installing-AndroidAPS/Building-APK.md) the generated APK to your phone (*on the linked page select 'Transfer APK to smartphone' in the navigation on the left*)
...
* BG source: `Dexcom G5 App (patched)`
  -- click cock-wheel and activate `Upload BG data to NS` and `Send BG data to xDrip+` (see [BG source](../Configuration/Config-Builder.md) - *on the linked page select 'BG Source' in the navigation on the left*)

![G5 Settings](../images/SampleSetupG5Settings.png)

* NS Client activated (see [NS Client](../Configuration/Config-Builder.md) and [Nightscout setup](../Installing-AndroidAPS/Nightscout.md))
