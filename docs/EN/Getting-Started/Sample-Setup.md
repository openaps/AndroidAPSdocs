...
A mmol/l version and a mg/dl version of the modified Dexcom G6 app are available at [https://github.com/dexcomapp/dexcomapp/tree/master/2.4](https://github.com/dexcomapp/dexcomapp/tree/master/2.4). You have to choose G6 app for your region.
