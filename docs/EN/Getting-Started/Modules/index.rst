...
------------------
* `Phone <../Phones.md>`_
* `Insulin pump choices <../Pump-Choices.md>`_
* `Possible future pump drivers  <../Future-possible-Pump-Drivers.md>`_
* `BG Source <./bgoverview.rst>`_
...
Optional Modules
-----------------
* `Smartwatch <../Phones.md>`_
   
Sample Setup
--------------  
* `Sample Setup: Samsung S7, Dana-R, Dexcom G5 and Sony Smartwatch <../Sample-Setup.md>`_
