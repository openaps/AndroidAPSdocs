...
* see also more tips for [particular types of battery](../Usage/Accu-Chek-Combo-Tips-for-Basic-usage.md) *(on the linked page select 'Pump battery considerations' in the navigation on the left)* to use for Combo pump
