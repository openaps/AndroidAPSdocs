...
* Blue triangles show [SMB](../Usage/Open-APS-features#super-micro-bolus-smb) - if enabled in [preferences](../Configuration/Preferences.html#openaps-smb-settings).
...
### Actions - section M
* Button [profile switch](../Usage/Profiles.html#profile-switch) as an alternative to pressing the [current profile](../Getting-Started/Screenshots.html#section-b-profile-target) on homescreen.
* Button [temporary target](../Usage/temptarget.html#temp-targets) as an alternative to pressing the [current target](../Getting-Started/Screenshots.html#section-b-profile-target) on homescreen.
