...
The easiest way to use Eversense with AndroidAPS is to install the modified [Eversense app](https://github.com/BernhardRo/Esel/blob/master/apk/esel.apk) (and unistall the original one first). You should have saved all your data before uninstalling the old app. 
To finally get your data the AndroidAPS, you need to install [ESEL](https://github.com/BernhardRo/Esel/blob/master/apk/mod_com.senseonics.gen12androidapp-release.apk) and enable "Send to AAPS and xDrip" in ESEL and "MM640g" in the Configuration Builder in AndroidAPS. As the BG data from Eversense can be noisy sometimes, it is good to enable "Smooth Data" in ESEL, which is a better than enabling "Always use short average delta instead of simple data".
You can find another instruction for xDrip [here](https://github.com/BernhardRo/Esel/tree/master/apk).
