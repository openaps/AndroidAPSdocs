...
Once you are fine with the profile adjustments you can [clone the profile](../Configuration/profilehelper.html#clone-profile) as described below.
...
If you use [local profiles](../Configuration/Config-Builder.html#local-profile) you can clone a profile / profile switch directly from profile helper.
