...
* So far life cannot be extended for transmitters who's serial no. starts with 8G, 8H or 8J. Same is true for transmitters with serial no. starting with 81 and firmware 1.6.5.**27** (see xDrip+ System Status - G5/G6 status as shown in [screenshot above](../Configuration/xdrip.html#transmitter-battery-status)).
...
* Enter Sensor code (on the peel-off foil of the sensor)
   ...
   - Code can also be found in [xDrip+ logs](../Configuration/xdrip.html#retrieve-sensor-code): Click 3-dots-menu on xDrip+ homescreen and choose `View Event Logs`.
...
* Details can be found on [screenshots page](../Getting-Started/Screenshots.html#sensor-level-battery).
