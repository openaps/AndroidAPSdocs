...
**AAPS** has a series of **Objectives** required to be completed to help progress from basic open looping to hybrid closed looping and full **AAPS** functionality. Completing the **objectives** aims to ensure:
...
- Select the correct CGM/FGM in [Config Builder](../Configuration/Config-Builder.md). See [BG Source](../Configuration/BG-Source.md) for more information.
...
- Select Open Loop either from the [Preferences](../Configuration/Preferences.md) menu or by pressing and holding the Loop icon on the top left of the **Overview** screen.
...
|         | Profile _low_ [target](../Getting-Started/Your-AAPS-Profile.md#glucose-targets) | Profile _high_ target  | [Temporary target](../Usage/temptarget.md) |
|---------|---------------------------------------------------------------------------------|------------------------|--------------------------------------------|
...
- Select **Closed Loop** either from [Preferences](../Configuration/Preferences.md) or by pressing and holding the Loop icon in the top right corner of the **Overview** screen. Stay in **Closed Loop** over a period of 1 day.
...
- The [SMB section in this documentation](Open-APS-features.md#super-micro-bolus-smb) and [oref1 coverage in the openAPS docs](https://openaps.readthedocs.io/en/latest/docs/Customize-Iterate/oref1.html) are must-reads to understand SMB and the concept of zero-temping.
...
- Search the [Facebook](https://www.facebook.com/groups/AndroidAPSUsers) and [Discord](https://discord.gg/4fQUWHZ4Mw) groups for discussions about Dynamic ISF and read about other users' experiences and recommendations. 
