...
* When AAPS reports a **pump unreachable** alarm, first release the keylock and **press any key on the pump** (e.g. "down" button). As soon as the pump display has turned off, press **UPDATE** on the **Combo Tab** in AAPS. Mostly then the communication works again.
* If that does not help, reboot your smartphone. After the restart, AAPS and ruffy will be reactivated and a new connection will be established with the pump.
...
![No connection to pump](../images/combo/combo-tips-no-connection-to-pump.png)
