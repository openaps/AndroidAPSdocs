...
* **Objective 1:** Setting up visualization and monitoring, and analysing basals and ratios
  ...
  * Follow instructions in [Nightscout](../Installin-AndroidAPS/Nightscout.html) page to ensure Nightscout can receive and display this data.
...
 
* **Objective 7:** Enabling additional Ooef0 features for daytime use, such as advanced meal assist (AMA)
