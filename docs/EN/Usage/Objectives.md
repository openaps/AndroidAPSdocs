...
- You have to start objective 10 to be able to use [Automation](../Usage/Automation.html).
...
One objective was removed when Android APS 3.0 was released.  Users of Android APS version 2.8.2.1 who are on older Android software (i.e. earlier than version 9) will be using an older set of objectives which can be found [here](../Usage/Objectives_old.html).
