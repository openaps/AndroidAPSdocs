...
* Probably not an option if using [patched LibreLink app](../EN/Hardware/Libre2#time-zone-travelling) as automatic time zone must be set to start a new Libre 2 sensor.
