...
Be aware of the [security issues](../Installing-AndroidAPS/Nightscout.html#security-considerations) that might occure and be very careful if you are using an [Insight pump](../Configuration/Accu-Chek-Insight-Pump.html#settings-in-aaps).
