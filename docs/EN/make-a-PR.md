...
For hints how to format text (headline, bold...) and set links please see the ["code syntax"](./make-a-PR.md#code-syntax) section of this page.
...
* internal link to .rst page: `[alt text](../folder/file.md)`
