...
All the settings for OpenAPS SMB are described in the dedicated section in [Key **AAPS** Features > Super Micro Bolus (SMB)](../DailyLifeWithAaps/KeyAapsFeaturesfixme.md#advanced-meal-assist-ama).
