...
- In **Config Builder → Synchronization**, select **NSClientV3**.
...
In **AAPS** v4 they are **no longer plugins** — there is nothing to enable in the Config Builder anymore. Everything has moved into the **Manage** bottom sheet, opened from the bottom navigation:
