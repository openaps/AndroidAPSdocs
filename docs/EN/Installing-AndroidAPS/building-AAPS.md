...
![SDKcomponents_setup](../images/Building-the-App/10_SDKComponents_setup.png)

When asked to verify settings, just select "Next":

![verify_settings](../images/Building-the-App/11_Verify_settings.png)

When asked about the Licence Agreement, select "Accept" and then click "Finish":

![licence_agreement](../images/Building-the-App/12_Licence_agreement.png)
...
![downloading_components](../images/Building-the-App/13_downloading_components.png)
...
![Select_URL](../images/Building-the-App/17_select_URL.png)


You will now see a screen telling you that the repository is being cloned:

![cloning_repository](../images/Building-the-App/18_cloning_repository.png)
...
![version_control](../images/Building-the-App/21_AS_version_control.png)
...
* If the automatic setting is successful, your current version of **Git** will be displayed next to the path.
   ...
   ![Git_version_displayed](../images/Building-the-App/23_Git__path_success.png)
...
When the Git version is displayed next to the path (see screenshot above) you have completed this stage successfully and you can close the Android Studio "Settings" window by clicking the "**OK**" button (5):
  ...
  ![Git_path_OK](../images/Building-the-App/23a_Git_path_OK.png)
...
![Create_key_store](../images/Building-the-App/27_new_keystore.png)
...
![Android_Studio_building](../images/Building-the-App/34_Studio_building2.png)
