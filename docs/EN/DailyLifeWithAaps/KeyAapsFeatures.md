...
* Currently, it is only available with a Dexcom G5 or G6, if using the [Build your own Dexcom App](../CompatibleCgms/DexcomG6.md#if-using-g6-with-build-your-own-dexcom-app) or “[native mode](../CompatibleCgms/SmoothingBloodGlucoseData.md#xdrip-with-dexcom-g6-or-dexcom-one)” in xDrip+. If a BG value has too large of a deviation, the G5/G6 doesn’t send it and waits for the next value 5 minutes later.
