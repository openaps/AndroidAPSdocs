...
* `Heroku <http://www.nightscout.info/wiki/welcome/set-up-nightscout-using-heroku>`_, (manuelle Einrichtung, Server im Ausland)
  * Du musst folgende Variablen konfigiurieren:
