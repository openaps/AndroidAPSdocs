...
1. **Objective 1:** Visualisierung und Konstrolle einrichten, und die Basalrate und Faktoren überprüfen
...
2. **Objective 2:** Start mit Open Loop
...
3. **Objective 3:** Den Open Loop, mit seinen temp. Basal Empfehlungen, verstehen.
...
4. * **Objective 4:** Mit dem closed Loop mit Hypoabschaltung starten
...
5. **Objective 5:** Feineinstellung des closed Loops, max IOB über 0 erhöhen und schrittweise den Zielbereich verringern
...
6. **Objective 6:** Basalrate und Faktoren nachjustieren, falls erforderlich, und Auto-Sens Aktivierung
...
7. **Objective 7:** Zusätzliche Funktionen für den alltäglichen Gebrauch aktivieren, wie Advanced Meal Assist (AMA)
